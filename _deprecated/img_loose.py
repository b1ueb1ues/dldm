...
def alphaa8(base_file_name, size=(1024, 1024)):
    ...
    if os.path.exists(alpha_file_name):
        ...
        if DST:
            fname = DST+'/'+os.path.basename(base_file_name)+"_rgba8.png"
        else:
...
def alpha(base_file_name, size=(1024, 1024)):
    ...
    if os.path.exists(alpha_file_name):
        ...
        merged = Image.merge("RGBA", (r,g,b,a))
        if DST:
            fname = DST+'/'+os.path.basename(base_file_name)+"_rgba.png"
        else:
...
def ycbcr(base_file_name):
    ...
    if os.path.exists(alpha_file_name):
        ...
        if DST:
            fname = DST+'/'+os.path.basename(base_file_name)+"_rgb.png"
        else:
